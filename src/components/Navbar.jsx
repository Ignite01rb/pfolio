      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed top-24 left-1/2 -translate-x-1/2 w-[98%] max-w-[180px] backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-10 flex flex-col items-center gap-8 md:hidden z-40 shadow-xl"
          >
            {links.map((link, index) => (
              <a
                key={index}
