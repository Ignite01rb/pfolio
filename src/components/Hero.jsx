    ...
    >
      ...
      <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center w-full max-w-7xl">
        ...
        <div className="relative flex justify-center mt-16 md:mt-0">
          ...
          {/* Glow Rings (Responsive Size) */}
          <div className="absolute w-72 h-72 sm:w-80 sm:h-80 md:w-96 md:h-96 border border-blue-500 rounded-full opacity-20 animate-pulse"></div>
          <div className="absolute w-60 h-60 sm:w-72 sm:h-72 md:w-80 md:h-80 border border-cyan-400 rounded-full opacity-20"></div>
          ...
          <div className="relative z-10">
            <img
              src={profile}
              alt="Raaghav Bisht"
              className="w-52 h-52 sm:w-64 sm:h-64 md:w-80 md:h-80 rounded-full object-cover border-4 border-blue-500 shadow-2xl"
            />

            {/* Social Icons */}
            <div className="absolute bottom-[-25px] left-1/2 -translate-x-1/2 flex gap-5 bg-[#0f172a] px-5 py-3 rounded-xl border border-white/10 shadow-xl">
              <a
